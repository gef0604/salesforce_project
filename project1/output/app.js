    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        key: 6
      }, [api_text("Account Name")]), api_element("th", {
        key: 7
      }, [api_text("Account Industry")]), api_element("th", {
        key: 8
      }, [api_text("Account Sector")]), api_element("th", {
        key: 9
      }, [api_text("Account Phone")])]), api_iterator($cmp.accs, function (acc) {
        return api_element("tr", {
          key: api_key(11, acc.id)
        }, [api_element("td", {
          key: 12
        }, [api_dynamic(acc.Name)]), api_element("td", {
          key: 13
        }, [api_dynamic(acc.Industry)]), api_element("td", {
          key: 14
        }, [api_dynamic(acc.Sector)]), api_element("td", {
          key: 15
        }, [api_dynamic(acc.Phone)])]);
      })]))])]), api_element("div", {
        key: 16,
        on: {
          "keypress": _m4 || ($ctx._m4 = api_bind($cmp.handleKeyPress))
